...
void interpretCmd_interpretState(char cComando,PID_DATA *pid_data, unsigned int uiVelocidadeM){
	...
	case 'p':/*kP do pid 0- 9,99*/
		if(cComando>= '0' && cComando <='9' ){
			...
			if(iFlag == 1){
					...
					PUTCHAR('C');
					PUTCHAR('K');
					pid_data->Pgain = ((double)iValor)/100.0;
					lcd_setCursor(0,10);
					lcd_writeData('K');
					lcd_setCursor(0,11);
					lcd_writeData('P');
		...
		if(cComando>= '0' && cComando <='9' ){
			...
			if(iFlag == 1){
				...
				cEstado = 'i';
					...
					PUTCHAR('C');
					PUTCHAR('K');
					pid_data->Igain = ((double)iValor)/100.0;
					lcd_setCursor(1,1);
					lcd_writeData('K');
					lcd_setCursor(1,2);
					lcd_writeData('I');
		...
		if(cComando>= '0' && cComando <='9' ){
			...
			if(iFlag == 1){
				...
				cEstado = 'd';
					...
					PUTCHAR('C');
					PUTCHAR('K');
					pid_data->Dgain = ((double)iValor)/100.0;
					lcd_setCursor(1,8);
					lcd_writeData('K');
					lcd_setCursor(1,9);
					lcd_writeData('D');
